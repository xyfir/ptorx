...
export default () => (
  <div className='features'>
    ...
    <p>
      Ready to purchase a Ptorx subscription? You can do so <a href='/app/#/account/purchase-subscription'>here</a>. $25 gets you access to all of those features, plus any future ones for an entire year.
    </p>
  </div>
)